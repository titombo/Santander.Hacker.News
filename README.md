...
## Author's notes for this solution ✍️
...
### Day 1 🗓️
> Started at 🗓️ **17/11/2025** · 🕒 **20:00 – 23:30**

What I did (step-by-step)
1. Architectural decisions
   - Defined a small layered layout: Repository → Service → Web (minimal API).
...
6. Mapping and presentation
   - Added AutoMapper mapping (Story → StoryViewModel) and centralized mapping registration.
...
### Day 2 🗓️
> Started at 🗓️ **18/11/2025** · 🕒 **08:00 – 09:00** and **12:00 – 12:30**
...
### Day 3 🗓️
> Started it on different times of the day at 🗓️ **19/11/2025** 
...
## Improvements if I had more time ⚠️
...
- API contract and client friendliness
  - Problem: Endpoint returns only an array — no pagination.
...
Important implementation details ⚙️
--------------------------------
